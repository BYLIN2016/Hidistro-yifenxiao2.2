namespace Hidistro.UI.Web.Admin
{
    ...
    public class SetOrderOption : AdminPage
    {
        ...
        protected HtmlGenericControl txtKeyTip;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                this.txtKey.Text = "";
                if (node.Attributes["Kuaidi100NewKey"] != null)
                {
                    this.txtKey.Text = node.Attributes["Kuaidi100NewKey"].Value;
                }
            }
        ...
        private void SavaKuaidi100Key()
        {
            ...
            if (node.Attributes["Kuaidi100NewKey"] != null)
            {
                node.Attributes["Kuaidi100NewKey"].Value = this.txtKey.Text;
            }
            else
            {
                XmlAttribute attribute = document.CreateAttribute("Kuaidi100NewKey");
                attribute.Value = this.txtKey.Text;
