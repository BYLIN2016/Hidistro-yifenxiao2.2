namespace Hidistro.UI.Web.Admin.product.ascx
{
    ...
    public class SpecificationView : UserControl
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            target.AttributeName = Globals.HtmlEncode(this.txtName.Text).Replace("，", ",");
            target.UsageMode = AttributeUseageMode.Choose;
            target.UseAttributeImage = this.radIsImage.SelectedValue;
