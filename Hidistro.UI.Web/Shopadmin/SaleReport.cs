namespace Hidistro.UI.Web.Shopadmin
{
    ...
    public class SaleReport : DistributorPage
    {
        ...
        {
            DataTable table = SubsiteSalesHelper.GetDaySaleTotal(this.dayYear, this.dayMonth, this.dayType);
            ...
            decimal money = SubsiteSalesHelper.GetMonthSaleTotal(this.dayYear, this.dayMonth, this.dayType);
            if (this.radioDayForSaleType.SelectedValue == SaleStatisticsType.SaleCounts)
            {
        ...
        {
            DataTable monthSaleTotal = SubsiteSalesHelper.GetMonthSaleTotal(this.monthYear, this.monthType);
