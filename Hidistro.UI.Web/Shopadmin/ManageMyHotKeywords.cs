    ...
    public class ManageMyHotKeywords : DistributorPage
    {
        ...
        private void btnEditHotkeyword_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    SubsiteStoreHelper.UpdateHotWords(hid, this.dropEditCategory.SelectedValue.Value, this.txtEditHotKeyword.Text.Trim());
                    this.BindData();
                }
            }
        }
        ...
        private void btnSubmitHotkeyword_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (string str2 in strArray)
                {
                    ...
                    {
                        SubsiteStoreHelper.AddHotkeywords(this.dropCategory.SelectedValue.Value, str2);
                        num++;
                    }
                }
                if (num > 0)
