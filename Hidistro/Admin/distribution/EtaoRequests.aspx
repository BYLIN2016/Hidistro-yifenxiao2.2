<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EtaoRequests.aspx.cs" Inherits="Hidistro.UI.Web.Admin.distribution.EtaoReuest" %>
...
<div class="optiongroup mainwidth">
		<ul>
           <li class="optionstar"><a href="ManageEtao.aspx" class="optionnext"><span>通一淘站点管理</span></a></li>
            <li class="menucurrent"><a href="EtaoRequests.aspx" class="optioncurrentend"><span class="optioncenter">通一淘站点审核</span></a></li>
		</ul>
	</div>
                  ...
                  <asp:TemplateField HeaderText="操作" HeaderStyle-Width="40%" HeaderStyle-CssClass="td_left td_right_fff">
                        <ItemTemplate>
                             <span class="submit_chakan"><a href="javascript:void(0);" onclick="ShowSiteMessage('<%#Eval("UserId") %>');">查看</a> </span>
                                 <span class="submit_chakan"><Hi:ImageLinkButton ID="btnPass" Text="通过" runat="server"    CommandArgument='<%#Eval("UserID") %>' CommandName="pass"  /> </span>
                                       <span class="submit_chakan"><Hi:ImageLinkButton ID="btnrefuse" Text="拒绝" runat="server"  CommandArgument='<%#Eval("UserID") %>' CommandName="refuse"  /> </span>
                        </ItemTemplate>
                  </asp:TemplateField>
              </Columns>
            </UI:Grid>
