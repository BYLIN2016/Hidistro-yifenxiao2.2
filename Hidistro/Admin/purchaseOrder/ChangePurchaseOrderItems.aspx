<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ChangePurchaseOrderItems.aspx.cs" Inherits="Hidistro.UI.Web.Admin.purchaseOrder.ChangePurchaseOrderItems" %>
  ...
  <div class="datalist">
    <UI:Grid runat="server" ID="grdOrderItems" Width="100%" AllowSorting="false" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="成本价(元)" HeaderStyle-CssClass="td_right td_left">
                <ItemTemplate>
                    <Hi:FormatedMoneyLabel runat="server" Money='<%# Eval("ItemCostPrice") %>' />
                </ItemTemplate>
            </asp:TemplateField>
