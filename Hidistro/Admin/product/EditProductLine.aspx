<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.EditProductLine" %>
		...
		<div class="columnright">
		  <div class="title"> 
		   ...
		   <div class="formitem validator5">
            ...
            <ul class="btn Pa_140">
		    <asp:Button ID="btnSave" runat="server" OnClientClick="return PageIsValid();" Text="确 定"  CssClass="submit_DAqueding" />
            </ul>
	      </div>
  </div>
</div>
