...
<div class="functionHandleArea clearfix m_none">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="结束时间"  ItemStyle-Width="20%"  HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
                           <Hi:FormatedTimeLabel ID="lblEndDate" Time='<%#Eval("EndDate") %>' runat="server"></Hi:FormatedTimeLabel>
                       </ItemTemplate>
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="抢购价格"  ItemStyle-Width="20%"  HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
