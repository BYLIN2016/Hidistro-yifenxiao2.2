...
var t=$(_32e);
return {required:undefined,validType:(t.attr("validType")||undefined),missingMessage:(t.attr("missingMessage")||undefined),invalidMessage:(t.attr("invalidMessage")||undefined)};
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"请输入优惠券号.",invalidMessage:null,rules:{email:{validator:function(_32f){
