<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="UnderlingBalanceDrawRequest.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.UnderlingBalanceDrawRequest" %>
  ...
  <h1 class="title_height">提现申请</h1>
		...
		<div class="searcharea clearfix br_search">
			<ul>
				<li>
                <span>选择时间段：</span>
                <span><UI:WebCalendar CalendarType="StartDate" ID="calendarStart" runat="server" /></span>
                <span class="Pg_1010">至</span>
                <span><UI:WebCalendar ID="calendarEnd" runat="server" CalendarType="EndDate" /></span>
                <span>用户名：</span><span><asp:TextBox ID="txtUserName" runat="server" /></span>
              </li>
				<li>
...
<!--结束-->
		    ...
		    <UI:Grid ID="grdBalanceDrawRequest" DataKeyNames="UserId" runat="server" AutoGenerateColumns="false" GridLines="None" ShowHeader="true" AllowSorting="true" Width="100%"  HeaderStyle-CssClass="table_title" SortOrder="DESC">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="银行账户信息" HeaderStyle-CssClass="td_right td_left" >
                                    <itemtemplate>
                                        <img src="../images/Visa.gif" onmouseover="showBankMessage(this,'<%# Eval("BankName")%>','<%# Eval("AccountName")%>','<%# Eval("MerchantCode")%>')" onmouseout="CloseBankMessage()" />
                                    </itemtemplate>
                                </asp:TemplateField> 
                     <asp:TemplateField HeaderText="操作" ItemStyle-Width="20%" HeaderStyle-CssClass="td_right td_left">
                       ...
                       <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="td_left td_right_fff" >
                                    <itemtemplate>
                                        <img src="../images/xi.gif" onmouseover="showRemark(this,'<%# Eval("Remark")%>')" onmouseout="CloseRemark()" />
                                    </itemtemplate>
                                </asp:TemplateField>   
                    </Columns> 
              </UI:Grid>
  ...
  <div class="bottomBatchHandleArea clearfix">
     ...
     <div class="Visa" id="BandMessage" style="display:none; z-index:1000; position:absolute; background-color:White;">
<h1>银行账号信息</h1>
...
<div class="Visa" id="remark" style="display:none; z-index:1000; position:absolute; background-color:White;">
<h1>备注信息</h1>
