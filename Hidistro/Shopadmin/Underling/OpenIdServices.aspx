<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="OpenIdServices.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.OpenIdServices" %>
...
.loginTabao ul li.li1{height:46px;line-height:20px;clear:both;overflow:visible;}
.loginTabao ul li.li2{clear:both;line-height:30px;height:30px;overflow:visible;}
