<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="SetMyHeaderMenu.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.store.SetMyHeaderMenu" %>
...
<div class="optiongroup mainwidth">
    <ul>
        ...
        <li><a href="SiteUrlDetails.aspx" class="optionnext"><span>域名管理</span></a></li>
        <li class="menucurrent"><a href="#" class="optioncurrentend"><span class="optioncenter">页头菜单设置</span></a></li>
    </ul>
</div>
<div class="dataarea mainwidth databody">
    <div class="title">
      <em><img src="../images/01.gif" width="32" height="32" /></em>
        <h1>"<a href="ManageMyThemes.aspx"><asp:Literal runat="server" ID="litThemName"></asp:Literal></a>"模板的页头菜单</h1>
      ...
      <!--数据列表区域-->
		<div class="datalist">
            <div class="searcharea clearfix br_search">
			    <ul>
                    <li><asp:HyperLink ID="hlinkAddHeaderMenu" CssClass="submit_jia" Text="添加页头菜单" runat="server" NavigateUrl="AddMyHeaderMenu.aspx"/></li>
		 ...
		 <UI:Grid ID="grdMyHeaderMenu" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="Id" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title" >                                                        
            <Columns>   
                <asp:TemplateField HeaderText="显示顺序" HeaderStyle-CssClass="td_right td_left"> 
                    <ItemTemplate>
                        <asp:TextBox ID="txtDisplaySequence" runat="server" Width="60px" BorderStyle="Inset" BorderWidth="2px" Text='<%# Eval("DisplaySequence")%>' />		                            
                    </ItemTemplate>                                                         
                </asp:TemplateField>  
