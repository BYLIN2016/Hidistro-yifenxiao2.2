                    ...
                    <ItemTemplate>
                        <tr>
                            <td>&nbsp;
                                ...
                                <%# String.IsNullOrEmpty(Eval("ShipOrderNumber").ToString()) ? "" : "<br>物流单编号：" + Eval("ShipOrderNumber")%>
                                    ...
                                    <tr>
                                        <td style="border: none;">&nbsp;
                                            <span class="Name float">
                                                <a target="_blank" href='<%# "ManualPurchaseOrderDetails.aspx?purchaseOrderId="+Eval("PurchaseOrderId") %>'>详情</a>
                                            </span> 
                                            <span>
                                               <Hi:DistributorChangePurchaseOrderItemsHyperLink ID="lkbtnUpdatePurchaseOrder" PurchaseStatusCode='<%# Eval("PurchaseStatus") %>'
                                                            PurchaseOrderId='<%# Eval("PurchaseOrderId") %>' Target="_blank" Text="修改" runat="server" />
                                            </span>                                            
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td width="20%">
                                <span class="submit_faihuo">
                                    <asp:HyperLink ID="lkbtnPay" runat="server" NavigateUrl='<%# "ChoosePayment.aspx?PurchaseOrderId="+ Eval("PurchaseOrderId")+"&PayMode="+Eval("PaymentTypeId") %>'
                                        Target="_blank" Text="付款" Visible="false" /></span> <span class="submit_tongyi">
                                ...
                                <a href="javascript:void(0)" onclick="return ApplyForPurchaseReturn(this.title)"
                                    ...
                                    申请退货</a> <a href="javascript:void(0)" onclick="return ApplyForPurchaseReplace(this.title)"
    ...
    <div class="Pop_up" id="refund_div" style="display: none">
        ...
        <div class="mianform">
            <ul>
                ...
                <li><span class="formitemtitle Pw_160">选择退款途径：<em>*</em></span> <span>
                    <abbr class="formselect">
                ...
                <li><span class="formitemtitle Pw_160">申请原因以及退款帐号：<em>*</em><br />
    ...
    <div class="Pop_up" id="return_div" style="display: none">
        ...
        <div class="mianform">
            <ul>
                ...
                <li><span class="formitemtitle Pw_160">申请原因，物流公司，物流单号，退款账号等：<em>*</em><br />
                    （银行转账，请填写您的银行账号相关信息）</span> <span>
    ...
    <div class="Pop_up" id="replace_div" style="display: none">
        ...
        <div class="mianform">
            <ul>
                ...
                <li><span class="formitemtitle Pw_160">换货备注：<em>*</em></span> <span>
