<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MyPurchaseOrderDetails.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyPurchaseOrderDetails" %>
...
<div class="dataarea mainwidth databody">
    ...
    <div class="Purchase">
      <div class="State">
        <ul>
        	<li>
                <strong class="fonts colorE">当前采购单状态：<Hi:PuchaseStatusLabel runat="server" ID="lblPurchaseStatus"></Hi:PuchaseStatusLabel></strong> 
                <asp:Label runat="server" ID="lbCloseReason" Text="关闭原因："><asp:Label runat="server" ID="lbReason"></asp:Label></asp:Label>
                <asp:Label runat="server" ID="lbPurchaseOrderReturn" Text="退款金额："><Hi:FormatedMoneyLabel ID="lblPurchaseOrderRefundMoney" runat="server" /></asp:Label>
            </li>
            <li class="Pg_8">
                <span class="submit_faihuo"><asp:HyperLink runat="server" ID="lkbtnPay" Text="付款" /></span>
                <span class="submit_btnguanbi"><a runat="server" id="lkbtnClosePurchaseOrder" href="javascript:DivWindowOpen(550, 200, 'ClosePurchaseOrder')">取消采购</a></span>
           </li>                     
        </ul>
      </div>
    </div>
