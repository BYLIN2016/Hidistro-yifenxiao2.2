<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderGifts.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.PurchaseOrderGifts" %>
    ...
    <div class="left">
      ...
      <div class="youhuiproductlist">
        <asp:DataList runat="server" ID="dlstGifts" Width="100%" DataKeyField="GiftId" RepeatLayout="Table">
          ...
          <tr>
            <td width="27%" height="28" valign="top"><span class="colorC">采购价：<Hi:FormatedMoneyLabel ID="lblPrice" runat="server" Money='<%# Eval("PurchasePrice")%>'  /></span></td>
    ...
    <div class="right">
      ...
      <ul>
       ...
       <div class="youhuiproductlist">
         ...
         <div class="pagination" style="margin-top:10px;">
				<UI:Pager runat="server" ShowTotalPages="false" ID="pagerOrderGifts" PageIndexFormat="pageindex1" ></UI:Pager>
				</div>
