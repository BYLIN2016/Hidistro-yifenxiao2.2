<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="ManageMyRefundNote.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.sales.ManageMyRefundNote" %>
...
<script type="text/javascript">
    function showRemark(objThis, remark, adminRemark) {
        if (remark == "" && adminRemark == "") {
            ...
            $("#spanRemark").html("会员退款原因：" + remark + "<br/>" + "管理员备注：" + adminRemark);
        }
 ...
 <!--选项卡-->
    <div class="optiongroup mainwidth">
	  <ul>
        ...
        <li class="menucurrent"><a href="#"><span>退款单</span></a></li>
	    <li><a href="ManageMyReturnNote.aspx"><span>退货单</span></a></li>
      </ul>
    </div>
