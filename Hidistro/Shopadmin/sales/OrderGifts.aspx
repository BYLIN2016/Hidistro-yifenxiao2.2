<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="OrderGifts.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.OrderGifts" %>
    ...
    <div class="left">
      ...
      <div class="youhuiproductlist">
        <asp:DataList runat="server" ID="dlstGifts" Width="100%" DataKeyField="GiftId" RepeatLayout="Table">
          ...
          <tr>
            <td width="27%" height="28" valign="top"><span class="colorC">成本价：<Hi:FormatedMoneyLabel ID="lblPrice" runat="server" Money='<%# Eval("PurchasePrice")%>'  /></span></td>
