<%@ Page Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="SetMyShipper.aspx.cs" Inherits="Hidistro.UI.Web.ShopAdmin.SetMyShipper" Title="无标题页" %>
      ...
      <div class="formitem validator4">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_110">发货人姓名：<em >*</em></span>
            ...
            <p id="ctl00_contentHolder_txtShipperNameTip">发货人姓名不能为空，长度在30个字符以内</p>
          </li>
