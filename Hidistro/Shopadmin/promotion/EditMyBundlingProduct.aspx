<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyBundlingProduct.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyBundlingProduct" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyBundlingProducts.aspx"><span>捆绑商品管理</span></a></li></ul></div>
      ...
      <div class="formitem validator5">
       ...
       <li><span class="formitemtitle Pw_140 ">选择商品：<em >*</em></span><span style="cursor:pointer; color:blue; font-size:14px"  onclick="ShowAddDiv();">请点此选择</span>
          ...
          <tr><th>商品名</th><th>sku信息</th><th>价格</th><th>数量</th><th>操作</th></tr>
...
$(document).ready(function () { InitValidators(); GetTotalPrice(); });</script>
</asp:Content>
