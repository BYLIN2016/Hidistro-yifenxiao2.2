 <%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="SearchBindProduct.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.SearchBindProduct" Title="无标题页" %>
  ...
  <span>商品查询，方便添加捆绑商品</span>
	  ...
	  <div class="datalist">
		...
		<!--结束-->
            ...
            <table>
                <tr class="table_title"><th class="td_right td_left">商品名称</th><th class="td_right td_left">商品名称</th></tr>
