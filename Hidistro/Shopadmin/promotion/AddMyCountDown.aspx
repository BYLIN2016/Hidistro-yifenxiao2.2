<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="AddMyCountDown.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyCountDown" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyCountDowns.aspx"><span>限时抢购管理</span></a></li></ul></div>
      <div class="columnright">
          <div class="title title_height">
            ...
            <h1 class="title_line">添加限时抢购活动</h1>
          </div>          
