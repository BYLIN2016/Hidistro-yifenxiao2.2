...
<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MyOrderPromtions.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyOrderPromtions" Title="无标题页" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <h1>订单促销活动</h1>
  <span>针对订单中的商品达到一定金额或数量时给予一定的优惠，您可以添加新的促销活动或管理当前的促销活动</span></div>
  
		<!-- 添加按钮-->
		  <div class="btn">
          <a href="AddMyOrderPromotions.aspx" class="submit_jia">添加订单促销活动</a>
	    </div>
	<!--结束-->
		<!--数据列表区域-->
	<div class="datalist">
   <UI:Grid ID="grdPromoteSales" runat="server" AutoGenerateColumns="false"  DataKeyNames="ActivityId" Width="100%" GridLines="None" HeaderStyle-CssClass="table_title" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                            <itemstyle width="100"  />
                            <itemtemplate>  
                                 <span class="submit_chakan"><a href='<%# "EditeMyOrderPromotions.aspx?ActivityId="+Eval("ActivityId")%>' >编辑</a></span>
