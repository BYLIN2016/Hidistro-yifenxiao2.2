<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyProductPromotions.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyProductPromotions" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyProductPromotions.aspx"><span>商品促销管理</span></a></li></ul></div>
      <div class="columnright">
          <div class="title title_height">
            <em><img src="../images/06.gif" width="32" height="32" /></em>
            <h1 class="title_line">编辑商品促销活动</h1>
          </div>
             ...
             <li> <span class="formitemtitle Pw_110">促销活动类型：<em>*</em></span>
                ...
                <table>
                    <tr>
                        ...
                        <td><span id="spDiscountValue"><span id="lblDiscountValueTip"></span><asp:TextBox ID="txtDiscountValue" runat="server" CssClass="forminput"></asp:TextBox></span></td></tr>
               </table>
               </li>              
