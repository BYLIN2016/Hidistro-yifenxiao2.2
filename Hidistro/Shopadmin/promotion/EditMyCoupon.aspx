<%@ Page Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyCoupon.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyCoupon"  %>
...
initValid(new InputValidator('ctl00_contentHolder_txtDateTo', 1, 10, false, '-?[0-9]\\d*',  ' 有效天数只能是数字，在1-730之间'))
appendValid(new NumberRangeValidator('ctl00_contentHolder_txtDateTo', 1, 730, ' 有效天数只能是数字，在1-730之间'));
}
