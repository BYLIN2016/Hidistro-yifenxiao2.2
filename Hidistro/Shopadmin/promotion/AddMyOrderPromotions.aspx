<%@ Page Title="" Language="C#" MasterPageFile="~/ShopAdmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="AddMyOrderPromotions.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyOrderPromotions" %>
...
<div class="columnleft clearfix"><ul><li><a href="MyOrderPromtions.aspx"><span>订单促销活动</span></a></li></ul></div>
      <div class="columnright">
          <div class="title title_height">
            ...
            <h1 class="title_line">添加订单促销活动</h1>
          </div>
