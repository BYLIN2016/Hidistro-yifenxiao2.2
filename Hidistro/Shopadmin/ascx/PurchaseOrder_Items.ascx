<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrder_Items.ascx.cs" Inherits="Hidistro.UI.Web.Shopadmin.PurchaseOrder_Items" %>
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.Common.Controls" Assembly="Hidistro.UI.Common.Controls" %>
 ...
 <asp:DataList ID="dlstOrderItems" runat="server" Width="100%" >
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="12%" class="td_right td_left">零售价(元) </td>
        <td width="12%" class="td_right td_left">采购价(元) </td>
        <td width="10%" class="td_right td_left">数量 </td>
        <td width="12%" class="td_right td_left">总零售价(元) </td>
