function ShowAddDiv() {
    DialogFrame(applicationPath+"/Shopadmin/promotion/SearchBindProduct.aspx", "添加捆绑商品", 1000, null);
}
...
function GetSearchData(pageindex) {
    $.ajax({
        url: "AddMyBundlingProduct.aspx?isCallback=true&serachName=" + $("#serachName").val() + "&categoryId=" + $("#ctl00_contentHolder_dropCategories").val() +
