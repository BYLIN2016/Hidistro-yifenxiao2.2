<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyInnerMessageTemplet.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyInnerMessageTemplet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="areacolumn clearfix">
      ...
      <li> <span class="formitemtitle Pw_100">消息类型：</span>
        ...
        <li class="clearfix"><span class="formitemtitle Pw_100">站内信标题：</span><asp:TextBox Width="300px" ID="txtMessageSubject" runat="server" CssClass="forminput" ></asp:TextBox>
      ...
      <div class="btn Pa_140"><asp:Button ID="btnSaveMessageTemplet" runat="server" OnClientClick="return PageIsValid();" Text="保 存"  CssClass="submit_DAqueding"/></div>
      </div>
  </div>
