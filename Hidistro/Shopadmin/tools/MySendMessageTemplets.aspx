<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MySendMessageTemplets.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MySendMessageTemplets" %>
...
<div class="dataarea mainwidth databody">
	  <div class="title m_none td_bottom  title_height"> <em><img src="../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">邮件短信设置</h1>
     </div>
	  <!-- 添加按钮-->
	  <!--结束-->
	  <!--数据列表区域-->
<div class="datalist">
	    <div class="search clearfix searcha">
			<ul>
				...
				<li>电子邮件</li>
                <li><a href="MyEmailSettings.aspx">配置</a></li>
                <li class="Pg_45"><img src="../images/p_icon09.gif" width="12" height="13" /></li>
                <li>手机短信</li>
                <li><a href="MySMSSettings.aspx">配置</a></li>
			</ul>
	</div>
	    ...
	    <HeaderStyle CssClass="table_title" />
            <Columns>                 
                ...
                <asp:TemplateField HeaderText = "电子邮件" HeaderStyle-CssClass="td_right td_left">    
                    ...
                    <td style="border:none;"><span class="submit_bianji float"><a href='<%# "EditMyEmailTemplet.aspx?MessageType="+Eval("MessageType")%>'>编辑</a></span></td></tr>
                    </table> 
                    </ItemTemplate>
                </asp:TemplateField>   
                <asp:TemplateField HeaderText="站内消息" HeaderStyle-CssClass="td_right td_left">                                                                                                        
                    ...
                    <td style="border:none;"><span class="submit_bianji"><a href='<%# "EditMyInnerMessageTemplet.aspx?MessageType="+Eval("MessageType")%>'>编辑</a></span></td></tr>
                    </table>                          
                    </ItemTemplate>
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="手机短信" HeaderStyle-CssClass="td_left td_right_fff">                                                                                                       
                    ...
                    <td style="border:none;"><span class="submit_bianji"><a href='<%# "EditMyCellPhoneMessageTemplet.aspx?MessageType="+Eval("MessageType")%>'>编辑</a></span></td></tr>
                    </table>                          
                    </ItemTemplate>
                </asp:TemplateField>                              
            </Columns>
