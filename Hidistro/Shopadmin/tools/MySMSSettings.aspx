<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MySMSSettings.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MySMSSettings" %>
 ...
 <div class="blank12 clearfix">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title m_none td_bottom">
            ...
            <asp:Label ID="lbNum" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#FF3300"></asp:Label>  &nbsp;<a href="http://sms.kuaidiantong.cn/SMSPackList.aspx" target="_blank" >购买</a>
        </div>
        <div class="datafrom">
            <div class="formitem">
