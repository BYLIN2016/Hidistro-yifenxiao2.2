<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MySendedMessages.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MySendedMessages" %>
    ...
    <div class="datalist">
        <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="MessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
           <Columns>                 
                ...
                <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                        <a target="_blank" href='<%# string.Format("../Underling/UnderlingDetails.aspx?userId={0}", Eval("AccepterUserId"))%>' ><%# Eval("Accepter")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
