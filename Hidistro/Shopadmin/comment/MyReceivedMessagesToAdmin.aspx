<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MyReceivedMessagesToAdmin.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyReceivedMessagesToAdmin" %>
...
<div class="optiongroup mainwidth">
	  <ul>
	    ...
	    <li><a href="MySendedMessagesToAdmin.aspx"><span>发件箱</span></a></li>
        <li class="optionend"><a href="SendMyMessageToAdmin.aspx"><span>发送站内信</span></a></li>
      </ul>      	
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/07.gif" width="32" height="32" /></em> <span class="title_height">你可以查看回复删除管理员发送给你的站内消息.</span> </div>
    <!--搜索-->
      ...
      <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="MessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
            <Columns>                 
                ...
                <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="5%">
                    <ItemTemplate>
                       <a href='<%# Globals.ApplicationPath+string.Format("/Shopadmin/comment/ReplayMyReceivedMessageToAdmin.aspx?MessageId={0}", Eval("MessageId"))%>' class='<%# Eval("IsRead").ToString()=="False"? "cstrong":"" %>'>回复</a>
                    </ItemTemplate>
                </asp:TemplateField>                            
            </Columns>
        </UI:Grid>         
