<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="ManageMyLeaveComments.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.ManageMyLeaveComments" %>
      ...
      <UI:Grid ID="leaveList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="LeaveId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
            <Columns>                 
                ...
                <asp:TemplateField HeaderText="发件人" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                        <a target="_blank" href='<%# string.Format("../Underling/UnderlingDetails.aspx?userId={0}", Eval("UserId"))%>' ><%#  Globals.HtmlDecode(Eval("UserName").ToString())%></a>
                    </ItemTemplate>
                </asp:TemplateField>
