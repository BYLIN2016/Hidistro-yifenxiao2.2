<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyHelpCategory.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyHelpCategory" %>
      ...
      <div class="formitem validator3">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_128">分类介绍：</span>
           <asp:TextBox ID="txtHelpCategoryDesc" TextMode="MultiLine" Height="70px" runat="server"></asp:TextBox>
