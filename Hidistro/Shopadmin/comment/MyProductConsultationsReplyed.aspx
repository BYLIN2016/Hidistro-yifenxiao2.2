<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MyProductConsultationsReplyed.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MyProductConsultationsReplyed" %>
...
<div class="optiongroup mainwidth">
	  <ul>
        <li class="optionstar"><a href="MyProductConsultations.aspx" class="optionnext"><span>未回复咨询</span></a></li>
	    <li class="menucurrent"><a href="MyProductConsultationsReplyed.aspx" class="optioncurrentend"><span>已回复咨询</span></a></li>
      </ul>
</div>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="30%" HeaderText="咨询内容" HeaderStyle-CssClass="td_right td_left">
                            ...
                            <ItemTemplate >
                               ...
                               <span class="p"><strong class="colorE">回复：</strong><asp:Label ID="Label1" runat="server" Text='<%# Eval("ReplyText") %>' CssClass="line"></asp:Label></span><span>回复时间：<Hi:FormatedTimeLabel ID="ConsultationDateTime1" Time='<%# Eval("ReplyDate") %>'
