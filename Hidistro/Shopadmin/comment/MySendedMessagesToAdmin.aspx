<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="MySendedMessagesToAdmin.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.MySendedMessagesToAdmin" %>
...
<div class="optiongroup mainwidth">
	<ul>
        <li class="optionstar"><a href="MyReceivedMessagesToAdmin.aspx" class="optionnext"><span>收件箱</span></a></li>
        <li class="menucurrent"><a href="javascript:void(0);"><span class="optioncenter">发件箱</span></a></li>
        <li><a href="SendMyMessageToAdmin.aspx"><span>发送站内信</span></a></li>
      </ul>
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/07.gif" width="32" height="32" /></em> <span class="title_height">你可以查看删除你发送给管理员的站内消息.</span> </div>
    <!--搜索-->
