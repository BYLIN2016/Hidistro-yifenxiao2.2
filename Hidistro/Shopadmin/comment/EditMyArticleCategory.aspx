<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="EditMyArticleCategory.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.EditMyArticleCategory" %>
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">分类介绍：</span>
           ...
           <p runat="server" id="txtArticleCategoryiesDescTip">分类介绍最多只能输入300个字符</p>
          </li>
      </ul>
      <ul class="btn Pa_100">
