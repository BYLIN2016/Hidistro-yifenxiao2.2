<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="AddMyHelp.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.AddMyHelp" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator3">
        <ul>
          <li> <span class="formitemtitle Pw_128">所属分类：<em >*</em></span><abbr class="formselect">
           <Hi:DistributorHelpCategoryDropDownList ID="dropHelpCategory" AllowNull="false" runat="server" />
          </abbr>
          <a href="AddMyHelpCategory.aspx">添加帮助分类</a></li>
          ...
          <li  class="clearfix"><span class="formitemtitle Pw_128">内容：<em >*</em></span>
