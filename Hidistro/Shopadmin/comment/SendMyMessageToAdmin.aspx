<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="SendMyMessageToAdmin.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.SendMyMessageToAdmin" %>
...
<div class="optiongroup mainwidth">
	  <ul>
	    <li class="optionstar"><a href="MyReceivedMessagesToAdmin.aspx"><span>收件箱</span></a></li>
        <li><a href="MySendedMessagesToAdmin.aspx" class="optionnext"><span>发件箱</span></a></li>
        <li class="menucurrent"><a href="javascript:void(0)"><span class="optioncenter">发送站内消息</span></a></li>
      </ul>
</div>
	<div class="dataarea mainwidth">
    <div class="toptitle"> <em><img src="../images/07.gif" width="32" height="32" /></em> <span class="title_height">发送站内消息给管理员.</span> </div>
    <div class="Emal">
    <ul>
    ...
    <div class="btn Pa_100 clear">
     <asp:Button ID="btnRefer" runat="server" OnClientClick="return PageIsValid();" Text="发送"  CssClass="submit_DAqueding"/>
    </div>
</div>
