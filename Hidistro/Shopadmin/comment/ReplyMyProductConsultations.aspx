<%@ Page Title="" Language="C#" MasterPageFile="~/Shopadmin/ShopAdmin.Master" AutoEventWireup="true" CodeBehind="ReplyMyProductConsultations.aspx.cs" Inherits="Hidistro.UI.Web.Shopadmin.ReplyMyProductConsultations" %>
    ...
    <div class="formitem">
                <ul>
                  ...
                  <li > <span class="formitemtitle Pw_100">回复：</span> 
                    <span style="float:left;"><Kindeditor:KindeditorControl FileCategoryJson="~/Shopadmin/FileCategoryJson.aspx" UploadFileJson="~/Shopadmin/UploadFileJson.aspx" FileManagerJson="~/Shopadmin/FileManagerJson.aspx" ID="fckReplyText" runat="server" Width="550px"  height="200px" /></span>
                  </li>
                </ul>
