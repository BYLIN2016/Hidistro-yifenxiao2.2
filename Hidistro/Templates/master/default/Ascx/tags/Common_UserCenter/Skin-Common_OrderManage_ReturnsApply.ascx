...
<UI:Grid ID="listReturns" runat="server" SortOrderBy="ApplyForTime" SortOrder="Desc"
    AutoGenerateColumns="False" DataKeyNames="ReturnsId" AllowSorting="true" GridLines="None"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="退货留言">
            <ItemTemplate>
                <asp:Label ID="lblRefundReamrk" runat="server" Text='<%# Eval("Comments") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
