namespace Hidistro.SaleSystem.Catalog
{
    ...
    {
        private static readonly ProductMasterProvider _defaultInstance = (DataProviders.CreateInstance("Hidistro.SaleSystem.Data.ProductData,Hidistro.SaleSystem.Data") as ProductMasterProvider);
