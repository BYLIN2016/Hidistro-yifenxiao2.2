namespace Hidistro.AccountCenter.DistributionData
{
    ...
    public class CommentData : CommentSubsiteDataProvider
    {
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("INSERT INTO distro_Favorite(ProductId, UserId, Tags, Remark)VALUES(@ProductId, @UserId, @Tags, @Remark)");
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("DELETE FROM distro_Favorite WHERE FavoriteId = @FavoriteId");
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT COUNT(*) FROM distro_Favorite WHERE UserId=@UserId AND ProductId=@ProductId");
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, HiContext.Current.User.UserId);
            this.database.AddInParameter(sqlStringCommand, "ProductId", DbType.Int32, productId);
        ...
        public override DbQueryResult GetFavorites(int userId, string tags, Pagination page)
        {
            ...
            DbCommand storedProcCommand = this.database.GetStoredProcCommand("ac_Underling_Favorites_Get");
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT Discount FROM distro_MemberGrades WHERE GradeId=@GradeId AND CreateUserId = @CreateUserId");
        ...
        {
            DbCommand storedProcCommand = this.database.GetStoredProcCommand("ac_Underling_ConsultationsAndReplys_Get");
        ...
        public override ProductInfo GetProductDetails(int productId)
        {
            ...
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT * FROM distro_Products WHERE ProductId = @ProductId");
            this.database.AddInParameter(sqlStringCommand, "ProductId", DbType.Int32, productId);
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
                if (reader.Read())
        ...
        {
            DbCommand storedProcCommand = this.database.GetStoredProcCommand("ac_Underling_UserReviewsAndReplys_Get");
            this.database.AddInParameter(storedProcCommand, "PageIndex", DbType.Int32, query.PageIndex);
            this.database.AddInParameter(storedProcCommand, "PageSize", DbType.Int32, query.PageSize);
            this.database.AddInParameter(storedProcCommand, "IsCount", DbType.Boolean, query.IsCount);
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT COUNT(ReviewId) AS Count FROM distro_ProductReviews WHERE UserId=@UserId");
            this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, HiContext.Current.User.UserId);
            int num = 0;
            using (IDataReader reader = this.database.ExecuteReader(sqlStringCommand))
            {
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("UPDATE distro_Favorite SET Tags = @Tags, Remark = @Remark WHERE FavoriteId = @FavoriteId");
